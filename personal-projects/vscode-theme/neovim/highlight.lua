...
theme.set_highlights = function()
	...
	hl(0, "NonText", { fg = (c.vscLineNumber or c.vscTabOther), bg = c.vscBack })
	hl(0, "Pmenu", { fg = c.vscPopupFront, bg = c.vscPopupBack })
	hl(0, "PmenuSel", { fg = c.vscPopupFront or c.vscBack, bg = c.vscPopupHighlightBlue })
	...
	hl(0, "Search", { fg = c.vscNone, bg = c.vscSearchCurrent })
	...
	hl(0, "Whitespace", { fg = c.vscLineNumber or c.vscTabOther })

	-- Treesitter
	hl(0, "TSError", { fg = c.vscRed, bg = "NONE" })
	hl(0, "TSPunctBracket", { fg = c.vscFront, bg = "NONE" })
	hl(0, "TSPunctSpecial", { fg = c.vscFront, bg = "NONE" })
	hl(0, "markdownTSPunctSpecial", { fg = c.vscBlue or c.vscYellowOrange, bold = true })
	hl(0, "TSComment", { fg = c.vscGreen, bg = "NONE" })
	...
	hl(0, "TSTitle", { fg = c.vscBlue or c.vscYellowOrange, bold = true })
	...
	hl(0, "TSStrong", { fg = c.vscBlue or c.vscViolet, bold = true })
	hl(0, "TSURI", { fg = c.vscFront, bg = "NONE" })
	hl(0, "TSTextReference", { fg = c.vscOrange or c.vscYellowOrange })
	hl(0, "TSPunctDelimiter", { fg = c.vscFront, bg = "NONE" })
	hl(0, "TSStringEscape", { fg = c.vscOrange or c.vscYellowOrange, bold = true })
	...
	-- Markdown
	hl(0, "markdownBold", { fg = c.vscBlue or c.vscYellowOrange, bold = true })
	hl(0, "markdownCode", { fg = c.vscOrange, bg = "NONE" })
	hl(0, "markdownRule", { fg = c.vscBlue or c.vscYellowOrange, bold = true })
	hl(0, "markdownCodeDelimiter", { fg = c.vscFront, bg = "NONE" })
	hl(0, "markdownHeadingDelimiter", { fg = c.vscBlue or c.vscYellowOrange, bg = "NONE" })
	hl(0, "markdownFootnote", { fg = c.vscOrange or c.vscYellowOrange, bg = "NONE" })
	hl(0, "markdownFootnoteDefinition", { fg = c.vscOrange or c.vscYellowOrange })
	hl(0, "markdownUrl", { fg = c.vscFront, bg = "NONE", underline = true })
	hl(0, "markdownLinkText", { fg = c.vscOrange or c.vscYellowOrange })
	hl(0, "markdownEscape", { fg = c.vscOrange or c.vscYellowOrange })
	...
	hl(0, "LspReferenceText", { fg = "NONE", bg = c.vscPopupHighlightGray or c.vscPopupHighlightLightBlue })
	hl(0, "LspReferenceRead", { fg = "NONE", bg = c.vscPopupHighlightGray or c.vscPopupHighlightLightBlue })
	hl(0, "LspReferenceWrite", { fg = "NONE", bg = c.vscPopupHighlightGray or c.vscPopupHighlightLightBlue })
	...
	hl(0, "CmpItemAbbrMatch", { fg = c.vscMediumBlue or c.vscDarkBlue, bg = "NONE", bold = true })
	hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.vscMediumBlue or c.vscDarkBlue, bg = "NONE", bold = true })

	-- Dashboard
	hl(0, "DashboardHeader", { fg = c.vscBlack, bg = "NONE" })
	hl(0, "DashboardCenter", { fg = c.vscButtonColor, bg = "NONE" })
	hl(0, "DashboardCenterIcon", { fg = c.vscYellowOrange, bg = "NONE" })
	hl(0, "DashboardShortCut", { fg = c.vscLightGray, bg = "NONE" })
	hl(0, "DashboardFooter", { fg = c.vscLightGray, bg = "NONE", italic = true })
	...
	hl(0, "TelescopeMatching", { fg = c.vscMediumBlue, bg = "NONE", bold = true, nil })
	hl(0, "TelescopePromptPrefix", { fg = c.vscFront, bg = "NONE" })
